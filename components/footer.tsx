        ...
        <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-4">
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Creating unforgettable wedding experiences. Let us help you plan the perfect day for your love story.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="flex items-start gap-2">
                ...
                <span className="text-muted-foreground">contact@weddingaudi.com</span>
              </li>
              <li className="flex items-start gap-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span className="text-muted-foreground">123 Wedding Street, San Francisco, CA 94107</span>
              </li>
            </ul>
          </div>
        </div>
